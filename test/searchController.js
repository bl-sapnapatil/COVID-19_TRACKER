    ...
    it('Request body cannot be undefined', () => {
		chai.request(server)
			...
			.end((err, res) => {
                ...
                res.body.should.have.property('error').eql('Request body cannot be undefined');
				res.body.should.have.property('message').eql('Error while getting data');
			});
    });
    ...
    it('Request body cannot be null', () => {
		chai.request(server)
			...
			.end((err, res) => {
				...
				res.body.should.be.a('Object');
                res.body.should.have.property('success').eql(false);
                res.body.should.have.property('error').eql('Request body cannot be null');
				res.body.should.have.property('message').eql('Error while getting data');
			});
    });
    ...
    it('Request body cannot be empty string', () => {
		chai.request(server)
			...
			.end((err, res) => {
				...
				res.body.should.be.a('Object');
                res.body.should.have.property('success').eql(false);
                res.body.should.have.property('error').eql('Request body cannot be empty');
				res.body.should.have.property('message').eql('Error while getting data');
			});
	});
});